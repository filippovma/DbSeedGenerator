...
namespace DbSeedGenerator.Tests
{
    public sealed class DbSeedGeneratorTests
    {
        ...
        {
            var result = DbSeedGenerator.GenCode(new TypeWithDiscardAttribute { Id = 1, Name = "test"});
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var typewithdiscardattribute_1 = new TypeWithDiscardAttribute {Name = @""test""};", result[0]);

        }

        internal class TypeWithOutForeignKey
        {
            [Key]
            public int Id { get; set; }
        ...
        [Fact]
        public void ShouldBeAvoidGenerationCodeForPropetiesWithIdSuffix()
        {
            var result = DbSeedGenerator.GenCode(new TypeWithOutForeignKey { Id = 1, Name = "test", ExternalId = 1 });
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var typewithoutforeignkey_1 = new TypeWithOutForeignKey {Name = @""test""};", result[0]);
        }
        ...
        {
            var result = DbSeedGenerator.GenCode(new IntContainer { Id = 1, Name = "test"});
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var intcontainer_1 = new IntContainer {Name = @""test""};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForBool()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal("var boolcontainer_1 = new BoolContainer {Value = true};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForGuid()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var guidcontainer_1 = new GuidContainer {Value = new Guid(""e2f0b4a8-4b5b-4d42-bff6-86b5a5df1ff6"")};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForString()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var stringcontainer_1 = new StringContainer {Value = @""string""};", result[0]);
        }
        ...
        public void ShouldBeCorrectEscapeStringWithQutationMark()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var stringcontainer_1 = new StringContainer {Value = @""s""""tring""};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForDateTime()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var datetimecontainer_1 = new DateTimeContainer {Value = new DateTime(2014, 1, 2, 3, 4, 5)};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForDecimal()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var decimalcontainer_1 = new DecimalContainer {Value = 10.12m};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForDouble()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var doublecontainer_1 = new DoubleContainer {Value = 10.12};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForFloat()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var floatcontainer_1 = new FloatContainer {Value = 10.12f};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForNullableTypeWhenPropertyHasNotValue()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var nullableboolcontainer_1 = new NullableBoolContainer {Value = null};", result[0]);
        }
        ...
        public void ShouldBeCorrectGenerateCodeForNullableTypeWhenPropertyHasValue()
        {
            ...
            Assert.Equal(1, result.Count);
            Assert.Equal(@"var nullableboolcontainer_1 = new NullableBoolContainer {Value = true};", result[0]);
        }
        ...
        public void ShouldBeGenerateValidCodeForSingleObject()
        {
            ...
            Assert.Equal(@"var subitem2type_3 = new SubItem2Type {Name = @""This is """"SubItem2""""""};", result[0]);
            Assert.Equal(@"var topitem_1 = new TopItem {Name = @""I'm TopItem""};", result[1]);
            Assert.Equal(@"var subitem1_2 = new SubItem1 {Name = @""I'm SubItem1"", TopItem = topitem_1};", result[2]);
            Assert.Equal(@"var subitem2_4 = new SubItem2 {Name = @""I'm Parent"", ParentSubItem = subitem1_2, Type = subitem2type_3};", result[3]);
            Assert.Equal(@"var subitem3type_5 = new SubItem3Type {Name = @""This is """"SubItem3""""""};", result[4]);
            Assert.Equal(@"var subitem3_6 = new SubItem3 {Name = @""I'm SubItem3"", Type = subitem3type_5, Parent = subitem2_4};", result[5]);
            Assert.Equal(@"var subitem4type_7 = new SubItem4Type {Name = @""This is """"SubItem4""""""};", result[6]);
            Assert.Equal(@"var subitem4_8 = new SubItem4 {Name = @""I'm SubItem4"", SubItem4Type = subitem4type_7, SubItem3 = subitem3_6};", result[7]);
        }
        ...
        public void ShouldBeGenerateValidCodeForMultipleObjects()
        {
            ...
            Assert.Equal(@"var subitem4type_7 = new SubItem4Type {Name = @""This is """"SubItem4""""""};", result[6]);
            Assert.Equal(@"var subitem4_8 = new SubItem4 {Name = @""I'm SubItem4"", SubItem4Type = subitem4type_7, SubItem3 = subitem3_6};", result[7]);
            Assert.Equal(@"var subitem4_9 = new SubItem4 {Name = @""I'm SubItem4"", SubItem4Type = subitem4type_7, SubItem3 = subitem3_6};", result[8]);
            Assert.Equal(@"var subitem4_10 = new SubItem4 {Name = @""I'm SubItem4"", SubItem4Type = subitem4type_7, SubItem3 = subitem3_6};", result[9]);
        }
    }
}
